...
export async function mainApp() {
    ...
    const headerImg1 = document.getElementById('header-bg-img-1') as HTMLImageElement;
    const headerImg2 = document.getElementById('header-bg-img-2') as HTMLImageElement;
    ...
    // --- Initial Load ---
    if (headerImg1) headerImg1.src = imageAssets.img2;
    if (headerImg2) headerImg2.src = imageAssets.img6;
